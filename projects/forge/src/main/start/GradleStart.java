...
public class GradleStart extends GradleStartCommon
{
    ...
    protected void setDefaultArguments(Map<String, String> argMap)
    {
        ...
        argMap.put("username",        "scott.barnes@gmail.com");
        argMap.put("password",        "n0nen0ne");
    }
    ...
    private static void hackNatives()
    {
        ...
        String nativesDir = "C:/Users/Scott/.gradle/caches/minecraft/net/minecraft/natives/1.8";
